...
Feature: Intake Tab 
  ...
  Scenario: Deleting relation via list
    ...
    Then "0413199525" should not appear in the "Procedures" sidebar #needs StepDef #notlogged
    Then "0413199525" should not appear in the "Related Intake Records" area #needs Stepdef #not logged
