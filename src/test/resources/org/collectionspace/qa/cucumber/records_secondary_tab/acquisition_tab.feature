...
Feature: Acquisition Tab
  # Enter feature description here
    ...
    Scenario: Working Acquisition Secondary Tab #1 
        ...
        And user selects the "Acquisition" tab
        Then "CQA99.1" should appear in the "Related Acquisition Records" area
    ...
    Scenario: Dismissing the dialog #3 
        ...
        Then the "Related Acquisition Records" area should only contain "CQA99.1"
    ...
    Scenario: Searching and adding multiple Acquisition records #5 
        ...
        Then "CQA99.3" should appear in the "Related Acquisition Records" area
        Then "CQA99.2" should appear in the "Related Acquisition Records" area 
        ...
        Then the "Acquisition Reference Number" field should contain "CQA99.3"
        And the user clicks the "Delete this relation." button
        Then a delete confirmation dialogue should appear
        And the user clicks the delete button 
        Then the deletion should be confirmed in a dialogue
        Then "CQA99.3" should not appear in the "Related Acquisition Records" area 


        And the user clicks on result with text "CQA99.2" 
        Then an "Edit Acquisition Record" form should be displayed 
        Then the "Acquisition Reference Number" field should contain "CQA99.2"
        And the user clicks the "Delete this relation." button
        Then a delete confirmation dialogue should appear
        And the user clicks the delete button 
        Then the deletion should be confirmed in a dialogue
        Then "CQA99.2" should not appear in the "Related Acquisition Records" area 
        Then close the browser
    ...
    Scenario: Warning when navigating away from new Acquisition record #7 
        ...
        And user enters "CQA99.4" in the "Acquisition Reference Number" field
        ...
        Then the "Acquisition Reference Number" field should contain "CQA99.4"
        ...
        And user selects the "Acquisition" tab 
        Then "CQA99.4" should not appear in the "Related Acquisition Records" area
        ...
        And user selects the "Acquisition" tab 
        Then "CQA99.4" should appear in the "Related Acquisition Records" area 
    ...
    Scenario: Cancel changes button #9 
        ...
        And user enters "CQA99.5" in the "Acquisition Reference Number" field
    ...
    Scenario: Testing links and "Go To Record" works #23 
        ...
        Then the "Acquisition Reference Number" field should contain "CQA99.1"
        And the user clicks the "Go to record" button
    ...
    Scenario: Deleting Relation via List #25 
        ...
        And the user clicks on the "Add record" button #needs step def
        And clicks on the Create button
        And user enters "CQA99.7" in the "Acquisition Reference Number" field #might not work 
        ...
        Then the "Related Acquisition Records" area should contain "CQA99.7"
        ...
        Then "CQA99.7" should not appear in the "Related Acquisition Records" area #needs Stepdef #not logged

        And user goes to the record with identification number "CQA99.7"
        And user selects the "Acquisition" tab 
        Then "CQA99_NE" should not appear in the "Related Acquisition Records" area  #needs Stepdef
        And user selects the "Current Record" tab
    ...
    Scenario: Deleting Relation via record editor #27 
        ...
        And the user clicks on the "Add record" button #needs step def
        And clicks on the Create button
        And user enters "CQA99.8" in the "Acquisition Reference Number" field #might not work 
        And the user saves the record
        ...
        Then the "Related Acquisition Records" area should contain "CQA99.8"
        ...
        Then "CQA99.8" should not appear in the "Related Acquisition Records" area
    ...
    Scenario: Testing Functional Accessibility #31 
        ...
        And user enters "CQA99.9" in the "Acquisition Reference Number" field #might not work 
        And the user saves the record
