...
Feature: Location­Movement­Inventory Control Tab
  # Enter feature description here
  	...
  	Scenario: Working Location-Movement-Inventory Secondary Tab #1
	    ...
	    # Then the Location-Movement-Inventory records should be listed in a table
  	...
  	Scenario: Searching and adding multiple Location-Movement-Inventory records
	    ...
	    Then the search results should contain "CQA113.1" 
	    Then the search results should contain "CQA113.2" 

	    And the user selects the box with result "CQA113.1" 
	    ...
	    Then "CQA113.1" should appear in the "Related Records" area  #needs Stepdef
	    Then "CQA113.2" should appear in the "Related Records" area  #needs Stepdef
	    Then "CQA113.1" should appear in the "Procedures" area  #needs Stepdef
	    Then "CQA113.2" should appear in the "Procedures" area  #needs Stepdef


	    And the user clicks on result with text "CQA113.1" # Might not work. #Change num?
	    ...
	    Then an "Edit Location­-Movement­-Inventory Control" form should be displayed # Be more specific? #Needs Stepdef #be different?
	    # This second form should be different somehow
	    # Delete relations: CQA113.1 and CQA113.2
	    Then close the browser
  	...
  	Scenario: Warning when navigating away from new Location-Movement-Inventory record #7
	    ...
	    #Variation A
			And user enters "CQA113.3" in the "Location-Movement-Inventory Number" field 
		...
		#Variation D
			And user enters "CQA113.4" in the "Location-Movement-Inventory Number" field
			# And the user clicks any link/item to navigate away from the current page
  	...
  	Scenario: Cancel changes button #9
	    ...
	    And user enters "CQA113.5" in the "SOMETHING FIELD" field #might not work
	    ...
	    # Enter a Location-Movement-Inventory number
	    ...
	    And user enters "CQA113.6" in the "SOMETHING FIELD" field #might not work
	...
	Scenario: Deleting relation via list #Test 25
	    ...
	    And user enters "CQA113.7" in the "Intake Entry Number" field #might not work 
	    ...
	    And selects "Location-Movement-Inventory" from the top nav search record type select field # And using the top right search area, select intake from the drop down
	    And user enters "CQA113.7" in the top nav search field
	    Then the search results should contain "CQA113.7"
	    And the user clicks on result with text "CQA113.7"
	    Then "CQA113.7" should be in the "Identification Number" field   #needs Stepdef
	    And user selects the "Location-Movement-Inventory" tab 
  	...
  	Scenario: Deleting relation via record editor #27
	    ...
	    And the user clicks on the "Add record" button #needs step def
	    And clicks on the Create button
	    And user enters "CQA113.8" in the "Intake Entry Number" field #might not work 
	    And the user saves the record
	    And the user clicks the result that contains "CQA113.8" in the "Entry Number" field
	    ...
	    And selects "Location-Movement-Inventory" from the top nav search record type select field # And using the top right search area, select Location-Movement-Inventory from the drop down
	    And user enters "CQA113.8" in the top nav search field
	    Then the search results should contain "CQA113.8"
	    And the user clicks on result with text "CQA113.8"
	    Then "CQA113.8" should be in the "Identification Number" field   #needs Stepdef
	    And user selects the "Location-Movement-Inventory" tab 
	    Then "CQA113_NE" should not appear in the "Related Location-Movement-Inventory Records" area  #needs Stepdef
	    #Necessary?:
		    # And user selects the "Current Record" tab 
  	...
  	Scenario: Testing Function Accessibility #31
	    ...
	    And user enters "CQA113.9" in the "Intake Entry Number" field #might not work 
	    And the user saves the record
