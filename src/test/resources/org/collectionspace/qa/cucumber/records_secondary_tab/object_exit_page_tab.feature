...
Feature: Object Exit Page Tab
  ...
  Scenario: Searching and adding multiple Object Exit records #5
	    ...
	    Then the search results should contain "CQA115.1" 
	    Then the search results should contain "CQA115.2" 

	    And the user selects the box with result "CQA115.1" 
	    ...
	    Then "CQA115.1" should appear in the "Related Records" area  #needs Stepdef
	    Then "CQA115.2" should appear in the "Related Records" area  #needs Stepdef
	    Then "CQA115.1" should appear in the "Procedures" area  #needs Stepdef
	    Then "CQA115.2" should appear in the "Procedures" area  #needs Stepdef


	    And the user clicks on result with text "CQA115.1" # Might not work. #Change num?
	    Then an "Edit Object Exit Control" form should be displayed # Be more specific? #Needs Stepdef
	    And the user clicks on result with text "CQA115.2" # Might not work. #Change num?
	    Then an "Edit Object Exit Control" form should be displayed # Be more specific? #Needs Stepdef #be different?
	    # This second form should be different somehow
	    # Delete relations: CQA115.1 and CQA115.2
	    Then close the browser
  ...
  Scenario: Warning when navigating away from Object Exit record #7
	    ...
	    #Variation A
			And user enters "CQA115.3" in the "Exit Number" field 
  ...
  Scenario: Cancel changes button #9
	    ...
	    And user enters "CQA115.5" in the "SOMETHING FIELD" field #might not work
	    ...
	    And user enters "CQA115.6" in the "SOMETHING FIELD" field #might not work
  ...
  Scenario: Deleting relation via list #25
	    ...
	    And user enters "CQA115.7" in the "Intake Entry Number" field #might not work 
	    ...
	    And selects "Object Exit" from the top nav search record type select field # And using the top right search area, select intake from the drop down
	    And user enters "CQA115.7" in the top nav search field
	    Then the search results should contain "CQA115.7"
	    And the user clicks on result with text "CQA115.7"
	    Then "CQA115.7" should be in the "Identification Number" field   #needs Stepdef
	    And user selects the "Object Exit" tab 
  ...
  Scenario: Deleting relation via record editor #27
	    ...
	    And the user clicks on the "Add record" button #needs step def
	    And clicks on the Create button
	    And user enters "CQA115.8" in the "Intake Entry Number" field #might not work 
	    And the user saves the record
	    And the user clicks the result that contains "CQA115.8" in the "Entry Number" field
	    ...
	    And selects "Object Exit" from the top nav search record type select field # And using the top right search area, select Object Exit from the drop down
	    And user enters "CQA115.8" in the top nav search field
	    Then the search results should contain "CQA115.8"
	    And the user clicks on result with text "CQA115.8"
	    Then "CQA115.8" should be in the "Identification Number" field   #needs Stepdef
	    And user selects the "Object Exit" tab 
	    Then "CQA115_NE" should not appear in the "Related Object Exit Records" area  #needs Stepdef
	    #Necessary?:
		    # And user selects the "Current Record" tab 
