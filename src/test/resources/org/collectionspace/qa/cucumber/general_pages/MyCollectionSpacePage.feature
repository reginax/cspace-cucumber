@general_pages.MyCollectionSpacePage
...
Feature: #Enter feature name here
  # Enter feature description here
    ...
    Then the titlebar should contain "Local Person"
      And user enters "Rob Miller_z" in the "Person" "Display Name" field
      And the user saves the record
    Then the record is successfully saved
    Then "Rob Miller_z" should be in the "Person" "Display Name" field
    Then the titlebar should contain "Local Person"
